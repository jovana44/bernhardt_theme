...
<div class="social-share__wrap">
    <div class="social-share">
        ...
        <ul>
            <li><a class="social-share__item social-icon-round" href="#"><img
                        src="<?php echo get_template_directory_uri(); ?>/images/email.svg" alt="email" width="20"
                        height="15"></a></li>
            <li><a class="social-share__item social-icon-round" href="<?php echo $facebookURL?>"><img
                        src="<?php echo get_template_directory_uri(); ?>/images/facebook.svg" alt="facebook" width="15"
                        height="15"></a></li>
            <li><a class="social-share__item social-icon-round" href="<?php echo $twitterURL?>"><img
